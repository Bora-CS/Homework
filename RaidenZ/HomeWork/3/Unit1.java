...
public class Unit1 {
	...
	public void secondTest() {
		...
		driver.findElement(By.xpath(
				"//a[contains(@title,'Apple MacBook Air (13-inch Retina display, 1.6GHz dual-core Intel Core i5, 128GB) - Silver (Latest Model)')]//h2[contains(@class,'a-text-normal')]"))
				.click();
		...
		if (!driver.findElement(By.xpath("//span[@class='a-size-medium sc-product-title a-text-bold']"))
				.isDisplayed()) {
