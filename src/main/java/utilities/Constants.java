...
public class Constants {
	...
	static String projPath = System.getProperty("user.dir").replaceAll("\\\\", "/");
	
	public static final String BORA_FORM_URL =  "file:///" + projPath + "/src/main/resources/MuradilE/index.html";
}
