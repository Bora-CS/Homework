...
public class Bora2 {
	...
	public static void main(String[] args) {
		...
		if(signupButton2.isDisplayed()) {
			System.out.println("Logn in button is on the page");
		}else {
			System.out.println("False");
		}
...
//		WebElement submitButton = driver.findElement(By.cssSelector("body > div > div > div > div > form > input"));
...
//		WebElement LinkElement = driver.findElement(By.xpath("//a[@class= 'alert-link']"));
//		if(LinkElement.isDisplayed()) {
//			System.out.println("Bora Coding Bootcamnp link is display on the page");
//		}else {
//			System.out.println("False");
//		}
